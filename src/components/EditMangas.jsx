        ...
        <>
          <div className="group" >
            <div className="bg-white  rounded-[20px] mt-[30px] w-[85%] mx-[8%]  xl:ml-[0%] sm:ml-[20%] sm:w-[60%] xl:w-[100%]  flex justify-between  shadow-lg  transition-transform duration-300 transform group-hover:scale-105 group-focus:scale-105 ">
              ...
              <Anchor /* style={{ backgroundColor: `${hover}`, color: `${color}` }}*/ className=" hidden xl:block bg-green-200 blod text-green-700 pt-[10px] mt-[13%]  pl-[26px]  ml-[12%] mb-[2%]  w-[90px]  h-[45px] rounded-[50000px] text-[18px] ">
                  Read
                </Anchor>
              </div>     
              <div className="">
